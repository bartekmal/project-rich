...
${RICH_BASE_SOFTWARE}/Brunel/build.${CMTCONFIG}/run -s GITCONDDBPATH=$RICH_BASE_SOFTWARE root -l -q -b "${RICH_BASE_SCRIPTS_GLOBAL_RECO}/RichKaonIDCompareFiles.C(\"${CURRENT_DIR}\",\"${REFERENCE_DIR}\",1)" >> ${SUBMIT_DIR}/plots.log
${RICH_BASE_SOFTWARE}/Brunel/build.${CMTCONFIG}/run -s GITCONDDBPATH=$RICH_BASE_SOFTWARE root -l -q -b "${RICH_BASE_SCRIPTS_GLOBAL_RECO}/RichKaonIDCompareFiles.C(\"${CURRENT_DIR}\",\"${REFERENCE_DIR}\",2)" >> ${SUBMIT_DIR}/plots.log
#${RICH_BASE_SOFTWARE}/Brunel/build.${CMTCONFIG}/run -s GITCONDDBPATH=$RICH_BASE_SOFTWARE root -l -q -b "${RICH_BASE_SCRIPTS_GLOBAL_RECO}/RichKaonIDCompareFiles.C(\"${CURRENT_DIR}\",\"${REFERENCE_DIR}\",3)" >> ${SUBMIT_DIR}/plots.log
