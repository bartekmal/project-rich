...
void RichPionIDCompareFiles(const std::string filePath1, const std::string filePath2, const int richNr = 0, const std::string title1 = "current", const std::string title2 = "reference")
{
